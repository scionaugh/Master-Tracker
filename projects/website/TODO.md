...
## Open
- [ ] 2026-06-19 — Archived store-launch.html (full store, NOT live) still shows 4 plugins/sections — rebuild to 9-plugin roster if/when scionaugh.com full store is un-archived.
...
## Done
- [x] 2026-06-19 — scionaugh.com LIVE store.html (coming-soon) updated to 9 plugins (chips ScioTape/Tube/Glue/Space/EQ/EQP/MB/Clip + ScioSee free, hero copy, meta). Staged; deploys Jul 5 batch.
