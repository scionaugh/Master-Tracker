...
- [ ] 2026-06-15 — [PHASE][GATED] Optional "Natural Phase" = Vicanek matched biquad, opt-in. Build ONLY if audibility A/B (high-Q 12-18 kHz bell, 44.1 kHz, no OS) says it's worth it; else ship 2-mode. Pull from shared suite matched-biquad code, don't reimplement. (Phase notes §7 ScioEQ, §9)
